...
setup(
	...
	scripts=['maec_to_stix/scripts/maec_2_stix.py','maec_to_stix/scripts/copy_config.py'],
    include_package_data=True,
    package_data={'maec_to_stix': ['indicator_extractor/config/*.json']},
    install_requires=['maec>=4.1.0.9,<4.1.1.0', 'cybox>=2.1.0.8,<2.1.1.0', 'stix>=1.1.1.2,<1.2.0.0'],
